                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="/backsite/role/{{ $role->id }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-actions text-right">
                                                    <a href="/backsite/role" style="width:120px;" class="btn bg-blue-grey text-white mr-1" onclick="return confirm('Are you sure want to close this page? , Any changes you make will not be saved.')">
